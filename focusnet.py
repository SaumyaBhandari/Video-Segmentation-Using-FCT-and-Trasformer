...
class Block_encoder_bottleneck(nn.Module):
    def __init__(self, blk, in_channels, out_channels, att_heads, dpr):
        ...
        ln_shape = Block_encoder_bottleneck.calc_activation_shape(in_channels, 3) # <--- Calculate the shape of output of Convolution
        self.norm1 = torch.nn.LayerNorm([out_channels, *ln_shape])
